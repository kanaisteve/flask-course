...
while True:
    ...
    if choice == 1:
        data = input("Enter the date of the expense (YYYY-MM-DD): ")
        ...
        cur.execute("INSERT INTO expenses (Date, description, category, price) VALUE (?, ?, ?, ?)", (date, descripiton, category, price))
        conn.commit()
